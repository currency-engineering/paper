...
\begin{figure}[H]
\centering
\includegraphics[scale=0.48]{04_exchange_transactions_and_errors/png/agreements}
...
What is aggregate supply, aggregate demand, agreements and error rates in practical terms? Do we
