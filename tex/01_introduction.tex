...
\begin{figure}
% <div id="fig_feedback_schema"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_economic_feedback_schema"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_control_problem"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_exchange_transactions"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_time_transactions"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_contract_transactions"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_external_transactions"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_exchange_only_feedback_schema"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_exchange_only_aggregate_model"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
%<div id="fig_equilibrium_aggregate_model"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_information_transmission"></div>
\centering
\includegraphics{img/example.pdf}
...
\begin{figure}
% <div id="fig_aggregate_overbooking"></div>
\centering
\includegraphics{img/example.pdf}
...
Figure 4 shows a relationship between 
...
\begin{figure}
% <p class="figure_title">Figure 1.19. Inflation Feedback</p>
% <div id="ui_multi"></div>
\centering
\includegraphics{img/example.pdf}
