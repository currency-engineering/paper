...
\begin{figure}[H]
\centering
\includegraphics[scale=0.48]{05_time_transactions/png/interest_control_failure1}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.48]{05_time_transactions/png/interest_control_failure2}
\caption{Interest Control Failure}
