...
\caption{Uncontrollability Tracking}
\label{fig:uncontrollability_problem}
\end{figure}

Uncontrollability tracking occurs until the rate of change in the inflation rate drops to zero or
...
inflation rate increases, uncontrollability tracking reduces the growth rate, increases the
...
\subsection{Uncontrollability Problem}
...
control system is uncontrollable.
